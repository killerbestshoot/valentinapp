...
import 'package:mon_premye_app/pages/enterprise/enterprise_control_center_page.dart';
import 'package:mon_premye_app/pages/transactions/new_transaction_page.dart';
import 'package:mon_premye_app/pages/owner/owner_admin_wallet_dashboard_page.dart';
import 'package:mon_premye_app/pages/owner/owner_admin_reports_page.dart';
...
import 'package:mon_premye_app/pages/users/user_role_manager_page.dart';
...
import 'package:mon_premye_app/pages/payout/withdraw_approval_page.dart';
import 'package:mon_premye_app/widgets/logout_action.dart';
  ...
  List<_DashboardAction> _actions(BuildContext context) {
    return [
      ...
      _DashboardAction(
        ...
        onTap: () => _open(context, const PayoutApprovalPage()),
      ),
      _DashboardAction(
        ...
        onTap: () => _open(context, const WithdrawApprovalPage()),
      ),
      _DashboardAction(
        title: 'Topup',
      ...
      _DashboardAction(
        title: 'Enterprise',
        subtitle: 'Manage all systems',
        icon: Icons.business_center_outlined,
        color: const Color(0xFF0B6E4F),
        onTap: () => _open(context, const EnterpriseControlCenterPage()),
      ),
      _DashboardAction(
        title: 'Services',
        subtitle: 'Enable products',
        icon: Icons.tune_outlined,
        color: const Color(0xFF0F766E),
        onTap: () => _open(context, const ServiceCatalogPage()),
      ),
      _DashboardAction(
        title: 'Transactions',
      ...
      _DashboardAction(
        title: 'Admin Reports',
        subtitle: 'System-wide exports',
        icon: Icons.query_stats_outlined,
        color: const Color(0xFF0369A1),
        onTap: () => _open(context, const OwnerAdminReportsPage()),
      ),
      _DashboardAction(
      ...
      _DashboardAction(
        title: 'System Health',
        subtitle: 'Check platform status',
        icon: Icons.monitor_heart_outlined,
        color: const Color(0xFF166534),
        onTap: () => _open(context, const SystemHealthPage()),
      ),
      _DashboardAction(
        title: 'Auth Debug',
      ...
      return _InfoPanel(
        child: Column(
          ...
          children: [
            ...
            const _InfoLine(label: 'Reserved', value: '0.00'),
            _InfoLine(label: 'Balance Doc', value: '${enterpriseId}_OWNER'),
            const Padding(
              padding: EdgeInsets.only(top: 8),
              child: Text('Mock Firebase aktif. Balance live pa konekte.'),
            ),
          ],
        ),
      );
...
class _MockMetricGrid extends StatelessWidget {
  const _MockMetricGrid();
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(
                'Mock Firebase aktif. Pa gen tranzaksyon live pou kounye a.',
              ),
            ),
          ],
        ),
