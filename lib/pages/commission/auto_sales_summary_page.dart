              ...
              return StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
                ...
                builder: (context, logsSnap) {
                  ...
                  for (final doc in txDocs) {
                    ...
                    byAgentCount[agentName] =
                        (byAgentCount[agentName] ?? 0) + 1;
                  ...
                  final topAgent =
                      agentEntries.isEmpty ? '-' : agentEntries.first.key;
                  final topService =
