  ...
  Future<void> _transferWallet() async {
    ...
    try {
      ...
      final receiverWalletRef =
          db.collection('wallets').doc(selectedReceiver!['uid']);

      final senderLedgerRef = db.collection('wallet_ledger').doc();
      final receiverLedgerRef = db.collection('wallet_ledger').doc();

      final transferId = db.collection('wallet_transfers').doc().id;
      ...
      setState(() {
        myWalletBalance =
            _toDouble((refreshedMyWallet.data() ?? <String, dynamic>{})['balance']);
        selectedReceiver = {
          ...selectedReceiver!,
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    child: Padding(
                      ...
                      child: Text(loading ? 'Tanpri tann...' : 'Search Receiver'),
                    ),
                  ),
                ),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _line('UID', (selectedReceiver!['uid'] ?? '').toString()),
                          _line('Name', (selectedReceiver!['displayName'] ?? '').toString()),
                          _line('Email', (selectedReceiver!['email'] ?? '').toString()),
                          _line('Role', (selectedReceiver!['role'] ?? '').toString()),
                          _line(
                            'Wallet',
