...
class _CashIssuesDashboardPageState extends State<CashIssuesDashboardPage> {
  ...
  Future<void> _reviewIssue({
    ...
    try {
      final db = FirebaseFirestore.instance;
      final logRef = db.collection('cash_issue_review_logs').doc();
      final walletLedgerRef = db.collection('wallet_ledger').doc();
      ...
      await db.runTransaction((tx) async {
        ...
        final currentReviewStatus =
            (freshData['reviewStatus'] ?? 'pending')
                .toString()
                .toLowerCase()
                .trim();
          ...
          return StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
            ...
            builder: (context, snap) {
              ...
              final docs = snap.data!.docs.toList()
                ..sort((a, b) {
                  final da =
                      _parseDate(a.data()['updatedAt'] ?? a.data()['createdAt']);
                  final dbv =
                      _parseDate(b.data()['updatedAt'] ?? b.data()['createdAt']);
