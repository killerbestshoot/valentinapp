          ...
          return ListView(
            ...
            children: [
              Row(
                children: [
                  _statCard(
                      'Valid', '$validCount', Icons.verified, Colors.green),
                  const SizedBox(width: 10),
                  _statCard(
                      'Invalid', '$invalidCount', Icons.cancel, Colors.red),
                  const SizedBox(width: 10),
                  _statCard('Suspicious', '$suspiciousCount', Icons.warning,
                      Colors.orange),
                ],
              ),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _line('Amount',
                              '${(d['paymentAmount'] ?? '').toString()} ${(d['paymentCurrency'] ?? '').toString()}'),
                          _line('Validated By',
                              (d['validatedBy'] ?? '').toString()),
