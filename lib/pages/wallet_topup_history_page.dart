                  ...
                  if (filteredDocs.isEmpty)
                    const Card(
                      child: Padding(
                        ...
                        child: Text('Pa gen wallet topup history pou filt sa a'),
                      ),
                    )
                  else
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              _line('Target UID', (d['targetUid'] ?? '').toString()),
                              _line('Target Name', (d['targetName'] ?? '').toString()),
                              _line('Target Email', (d['targetEmail'] ?? '').toString()),
                              _line('Target Role', (d['targetRole'] ?? '').toString()),
                              _line(
                                'Amount',
                                '${_fmtMoney(_toDouble(d['amount']))} ${(d['currency'] ?? 'USD').toString()}',
                              ),
                              _line('Requested By', (d['requestedByName'] ?? '').toString()),
                              _line('Requester Role', (d['requestedByRole'] ?? '').toString()),
                              ...
                              _line('Approved By', (d['approvedByName'] ?? '').toString()),
                              _line('Approved Role', (d['approvedByRole'] ?? '').toString()),
                              _line('Rejected By', (d['rejectedByName'] ?? '').toString()),
                              _line('Rejected Role', (d['rejectedByRole'] ?? '').toString()),
                              _line('Reject Note', (d['rejectNote'] ?? '').toString()),
