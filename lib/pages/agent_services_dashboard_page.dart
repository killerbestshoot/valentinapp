...
import 'dynamic_transaction_page.dart';
...
class AgentServicesDashboardPage extends StatelessWidget {
  ...
  Future<Map<String, dynamic>> _loadServicesWithFallback(String enterpriseId) async {
    final db = FirebaseFirestore.instance;
        ...
        builder: (context, profileSnap) {
          ...
          return FutureBuilder<Map<String, dynamic>>(
            ...
            builder: (context, serviceSnap) {
              ...
              final mode = (serviceSnap.data!['mode'] ?? 'enterprise').toString();
              ...
              return Column(
                children: [
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 4),
                        Text('Agent: ${(profile['displayName'] ?? '').toString()}'),
                  ...
                  Expanded(
                    child: docs.isEmpty
                        ? const Center(
                            child: Text('Pa gen svis disponib menm nan fallback la'),
                          )
                        : GridView.builder(
                            padding: const EdgeInsets.all(12),
                            gridDelegate:
