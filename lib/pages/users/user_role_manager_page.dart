...
class _UserRoleManagerPageState extends State<UserRoleManagerPage> {
  ...
  Future<void> _createUser() async {
    ...
    try {
      ...
      final appUserId = AppIds.userForRole(_selectedRole, seed: newUid);
      ...
      final enterpriseUserId = AppIds.enterpriseUser(
        seed: '$enterpriseId:$newUid:$_selectedRole',
      );

      await FirebaseFirestore.instance
          .collection('enterprise_users')
          .doc(enterpriseUserId)
          .set({
