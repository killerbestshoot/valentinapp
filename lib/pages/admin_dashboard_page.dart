                      ...
                      children: [
                        StreamBuilder<DocumentSnapshot<Map<String, dynamic>>>(
                          ...
                          builder: (context, enterpriseSnap) {
                            final enterprise =
                                enterpriseSnap.data?.data() ?? <String, dynamic>{};
                            final balance = _asDouble(
                              enterprise['balance'] ?? enterprise['liveBalance'],
                            );
                            final currency =
                        ...
                        StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
                          stream: FirebaseFirestore.instance
                              ...
                              .where('role', whereIn: ['agent', 'administrator'])
                              .snapshots(),
                            ...
                            if (docs.isEmpty) {
                              return const Card(
                                child: Padding(
                                  ...
                                  child: Text('Pa gen users aktif pou enterprise sa a.'),
                                ),
                              );
                            }
