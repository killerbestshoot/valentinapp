...
import '../services/wallet_topup_request_service.dart';
...
class _WalletTopupRequestPageState extends State<WalletTopupRequestPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final isAllowed = role == 'owner' || role == 'administrator' || role == 'admin';
                    ...
                    Card(
                      child: Padding(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text('ROLE: ${(myProfile?['role'] ?? '').toString()}'),
                            Text('ENTERPRISE: ${(myProfile?['enterpriseName'] ?? '').toString()}'),
                            Text('ENTERPRISE ID: ${(myProfile?['enterpriseId'] ?? '').toString()}'),
                          ],
                        ),
                      ),
                    ),
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        child: Padding(
                          ...
                          child: Text(loading ? 'Tanpri tann...' : 'Search Staff'),
                        ),
                      ),
                    ),
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              _line('UID', (selectedStaff!['uid'] ?? '').toString()),
                              _line('Name', (selectedStaff!['displayName'] ?? '').toString()),
                              _line('Email', (selectedStaff!['email'] ?? '').toString()),
                              _line('Role', (selectedStaff!['role'] ?? '').toString()),
                              _line(
                                'Wallet',
