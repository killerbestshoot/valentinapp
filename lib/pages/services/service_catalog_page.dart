...
class _ServiceCatalogPageState extends State<ServiceCatalogPage> {
                      ...
                      : () async {
                          ...
                          if (name.isEmpty) {
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(
                                  content: Text('Service name pa dwe vid.')),
                            );
                            return;
                          }
                          ...
                          try {
                            ...
                            final serviceId = AppIds.service(
                              seed:
                                  '$enterpriseId:${category.isEmpty ? 'general' : category}:$name',
                            );
                            ...
                            ScaffoldMessenger.of(this.context).showSnackBar(
                              SnackBar(
                                  content: Text('Erreur create service: $e')),
                            );
                          }
                        },
  ...
  Future<void> _openEditDialog(
    ...
    final enterpriseCtrl =
        TextEditingController(text: (data['enterpriseId'] ?? '').toString());
    final codeCtrl =
                  ...
                  onPressed: saving
                      ...
                      : () async {
                          ...
                          try {
                            ...
                            ScaffoldMessenger.of(this.context).showSnackBar(
                              SnackBar(
                                  content: Text('Erreur update service: $e')),
                            );
                          }
                        },
