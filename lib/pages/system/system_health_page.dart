...
class SystemHealthPage extends StatelessWidget {
  ...
  int _countRisk(
    ...
    for (final d in docs) {
      ...
      final beneficiary =
          (m['beneficiaryRiskStatus'] ?? '').toString().toLowerCase();
          ...
          return StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
            ...
            builder: (context, txSnap) {
              ...
              final txWithoutCommission = txDocs.where((d) {
                final m = d.data();
                final staffRole =
                    (m['staffRole'] ?? '').toString().toLowerCase();
                ...
                builder: (context, payoutSnap) {
                  ...
                  return StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
                    ...
                    builder: (context, flagSnap) {
                      ...
                      String agentsStatus =
                          totalAgents == 0 ? 'CRITICAL' : 'OK';
                      String txStatus =
                          totalTransactions == 0 ? 'WARNING' : 'OK';
