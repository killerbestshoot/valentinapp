...
class _WeeklyMonthlyClosingReportsPageState
    ...
    pdf.addPage(
      pw.MultiPage(
        build: (context) => [
          ...
          pw.Text('Enterprise: ${(profile['enterpriseName'] ?? '').toString()}'),
  ...
  Stream<QuerySnapshot<Map<String, dynamic>>> _closingStream(String enterpriseId) {
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          _line('Agent Commission', _fmtMoney(totalAgentCommission)),
                          _line('Owner Commission', _fmtMoney(totalOwnerCommission)),
                        ],
                      ),
                    ),
                  ),
