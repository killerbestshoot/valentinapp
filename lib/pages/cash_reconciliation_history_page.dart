          ...
          return StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
            ...
            builder: (context, snap) {
              ...
              final docs = snap.data!.docs.toList()
                ..sort((a, b) {
                  final da = _parseDate(a.data()['updatedAt'] ?? a.data()['createdAt']);
                  final db = _parseDate(b.data()['updatedAt'] ?? b.data()['createdAt']);
                  ...
                  if (filteredDocs.isEmpty)
                    const Card(
                      child: Padding(
                        ...
                        child: Text('Pa gen reconciliation history pou filt sa a'),
                      ),
                    )
                  else
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              _line('Transactions', (d['transactionCount'] ?? 0).toString()),
                              _line('Sales', _fmtMoney((d['totalSales'] as num?) ?? 0)),
                              _line('Cash Expected', _fmtMoney((d['cashExpected'] as num?) ?? 0)),
                              _line('Cash Counted', _fmtMoney((d['cashCounted'] as num?) ?? 0)),
                              _line('Difference', _fmtMoney(difference)),
                              _line('Notes', (d['notes'] ?? '').toString()),
                              _line('Updated At', _fmtDate(d['updatedAt'] ?? d['createdAt'])),
                            ],
                          ),
                        ),
                      );
