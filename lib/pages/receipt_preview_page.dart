            ...
            actions: [
              IconButton(
                ...
                onPressed: () {
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(
                      content: Text('Print preview ready. Nou ka ajoute PDF apre sa.'),
                    ),
                  );
                },
              ),
              IconButton(
                ...
                onPressed: () {
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(
                      content: Text('Receipt preview pare pou share/export pita.'),
                    ),
                  );
                },
              ),
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton.icon(
                            ...
                            onPressed: () {
                              ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(
                                  content: Text('Print preview ready. PDF ap vini nan pwochen etap la.'),
                                ),
                              );
                            },
                          ),
