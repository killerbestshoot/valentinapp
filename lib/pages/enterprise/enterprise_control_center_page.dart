                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SwitchListTile(
                      value: active,
                      onChanged:
                          saving ? null : (v) => setLocal(() => active = v),
                      ...
                      : () async {
                          ...
                          if (enterpriseId.isEmpty || name.isEmpty) {
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(
                                content:
                                    Text('Enterprise ID ak Name obligatwa.'),
                              ),
                            );
                            return;
                          }
                          ...
                          try {
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                content:
                                    Text('Enterprise created: $enterpriseId'),
                              ),
                            );
                          } catch (e) {
                            if (!mounted) return;
                      ...
                      : () async {
                          ...
                          try {
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                content:
                                    Text('Enterprise updated: $enterpriseId'),
                              ),
                            );
                          } catch (e) {
                            if (!mounted) return;
            ...
            Expanded(
              child: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
                ...
                builder: (context, entSnap) {
                  ...
                  if (entSnap.hasError) {
                    return Center(
                        child: Text('Erreur enterprises: ${entSnap.error}'));
                  }
                      ...
                      return StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
                        ...
                        builder: (context, balSnap) {
                          ...
                          if (balSnap.hasError) {
                            return Center(
                                child:
                                    Text('Erreur balances: ${balSnap.error}'));
                          }
                              ...
                              children: [
                                Wrap(
                                  ...
                                  children: [
                                    ...
                                    _statBox(
                                        'Active', '$activeCount', Colors.green),
                                    _statBox('Inactive', '$inactiveCount',
                                        Colors.red),
                                    _statBox(
                                      'Business Balance',
                          ...
                          return ListView(
                            children: [
                              Wrap(
                                ...
                                runSpacing: 12,
                                children: [
                                  _statBox('Enterprises', '${rows.length}',
                                      Colors.blue),
                                  _statBox(
                                      'Active', '$activeCount', Colors.green),
                                  _statBox(
                                      'Inactive', '$inactiveCount', Colors.red),
                                  _statBox(
                                    'Business Balance',
                                    '${totalBusinessBalance.toStringAsFixed(2)} USD',
                                    Colors.purple,
