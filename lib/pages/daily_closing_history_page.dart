...
class DailyClosingHistoryPage extends StatefulWidget {
  ...
  @override
  State<DailyClosingHistoryPage> createState() => _DailyClosingHistoryPageState();
}
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _line('Sales', _fmtMoney((d['totalAmount'] as num?) ?? 0)),
                          _line('Agent Comm.', _fmtMoney((d['totalAgentCommission'] as num?) ?? 0)),
                          _line('Owner Comm.', _fmtMoney((d['totalOwnerCommission'] as num?) ?? 0)),
