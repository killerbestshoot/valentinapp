                  ...
                  return StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
                    ...
                    builder: (context, commissionSnap) {
                      ...
                      if (commissionSnap.hasError) {
                        return Center(
                          child: Text('Erreur commission: ${commissionSnap.error}'),
                        );
                      }
                      ...
                      return StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
                        ...
                        builder: (context, payoutSnap) {
                          ...
                          for (final d in payoutDocs) {
                            ...
                            recentActivity.add({
                              'type': 'payout',
                              'title': (m['serviceName'] ?? 'payout').toString(),
                              'subtitle':
                              ...
                              children: [
                                ...
                                if (topServices.isEmpty)
                                  const Card(
                                    child: Padding(
                                      ...
                                      child: Text('Pa gen services pou peryd sa.'),
                                    ),
                                  )
                                else
                                ...
                                if (recentActivity.isEmpty)
                                  const Card(
                                    child: Padding(
                                      padding: EdgeInsets.all(16),
                                      child: Text('Pa gen aktivite pou peryd sa.'),
                                    ),
                                  )
                                else
                                  ...recentActivity.take(30).map((a) {
                                    return Card(
                                      child: ListTile(
                                        ...
                                        subtitle: Text(a['subtitle'].toString()),
                                      ),
                                    );
                                  }),
                              ],
